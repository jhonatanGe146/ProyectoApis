    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_tipoDocumento', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.tipodocumento')),
                ('id_tipoPersona', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.tipopersona')),
